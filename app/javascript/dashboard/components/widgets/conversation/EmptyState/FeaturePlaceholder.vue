  ...
  <div class="flex flex-col gap-2 mt-9">
    ...
    >
      <div class="flex items-center gap-2">
        <Hotkey
          custom-class="w-10 h-6 text-sm font-medium border-b-2 text-slate-7000 dark:text-slate-100 bg-slate-100 dark:bg-slate-700 border-slate-300 dark:border-slate-500"
        >
          ctrl
        </Hotkey>
        <Hotkey
